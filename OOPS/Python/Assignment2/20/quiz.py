...
from fillintheblanks import FillInTheBlanks
...
class Quiz:
    ...
    def __init__(self):
        ...
        self.problems.append(TrueFalse('Fall 2014 was short', True))
        self.problems.append(FillInTheBlanks(
            'Dibble means to ____ like a duck', 'quack'))
