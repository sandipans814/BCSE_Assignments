...
QT_MOC_LITERAL(1, 8, 17), // "sendMousePosition"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7), // "QPoint&"
QT_MOC_LITERAL(4, 35, 9) // "Mouse_Pos"

    },
    "myLabel\0sendMousePosition\0\0QPoint&\0"
    "Mouse_Pos"
};
...
void myLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myLabel::sendMousePosition)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myLabel::Mouse_Pos)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void myLabel::sendMousePosition(QPoint & _t1)
{
