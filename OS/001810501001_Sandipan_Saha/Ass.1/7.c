...
char* builtin_comm[] = {"newdir","editfile","content","info","exitnewshell"};
...
int main(int argc, char const *argv[])
{
	...
	printf("================ Welcome to BCSEIII-2020 shell ===============\n");
	printf("Hi! Good ");
	...
	if(hour>17 && hour<=23)
		...
		printf("Night\n");
	printf("newdir <directory>  : Create a new directory\n");
	printf("editfile [filename] : Edit a file\n");
	printf("content <filename>  : See contents of a file\n");
	printf("info <filename>     : Display info about file\n");
	printf("exitnewshell        : Exit form the shell\n");
	printf("======================================================\n");
	// Call the shell loop
	sh_loop();
