...
# Function to exit
function exitnewshell()
{
	echo "BCSEIII-2020: exiting..."
	exit 1
}
...
function start()
{
	...
	echo "======== Welcome to BCSEIII-2020 shell ==============="
	...
	echo "exitnewshell        : Exit form the shell"
	echo "=================================================="
